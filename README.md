...
Het script is geoptimaliseerd om **24/7** te draaien op een Raspberry Pi of server en vereist minimale systeembronnen.
...
* 📊 **Grafieken:** Genereert op verzoek een visuele grafiek van het prijsverloop van de dag.
* 📈 **Dagstatistieken:** Houdt continu bij wat de hoogste, laagste en gemiddelde prijs van de dag is.
* 🎨 **Duidelijke Meldingen:** Stuurt berichten met **dikgedrukte** prijzen en een compacte layout voor mobiel.
* 🛡️ **Anti-Spam:** Slimme logica voorkomt "klapperende" meldingen als de prijs rond een grens schommelt.
...
* 💬 **Commando's:**
    ...
    * `/grafiek` - Genereer een afbeelding van het prijsverloop van vandaag.
...
* `raspberryonbalansprijs.py` - Het hoofdscript (De motor van het programma).
